...
ActiveRecord::Schema.define(version: 20170328233429) do
  ...
  create_table "certtests", force: :cascade do |t|
    t.string   "name"
    t.text     "description"
    t.integer  "project_id"
    t.datetime "created_at",  null: false
  ...
  add_index "certtests", ["project_id"], name: "index_certtests_on_project_id", using: :btree
  ...
  add_foreign_key "certtests", "projects"
